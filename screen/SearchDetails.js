import {
  ...
  export default function SearchDetails({route, navigation}) {
    ...
    const getDetail = async () => {
      axiosConfig
        .get(`https://edumatelive.in/studentadmin/newadmin/api/ApiCommonController/teacherdescription/${id}`)
        .then(response => {
          setDetail(response.data.data[0]);
          console.log("aaaaaaaaaaaaa",response.data.data);
          setPid(response.data.data[0].id)
        })
        .catch(error => {
    ...
    const enrollNow = async () => {
      axios
        .post(
          `https://edumatelive.in/studentadmin/newadmin//api/ApiCommonController/studentfavuritepost`,{
            student_id: pid,
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView>
          ...
          <View
            ...
            Name :{' '}
              <Text style={styles.techName}>{detail?.s_name}</Text>
            </Text>
          </View>
          ...
          <View
            ...
            <Text style={styles.teacherName}>
              Experiance :{' '}
              <Text style={styles.techName}>{detail?.experiance}</Text>
            </Text>
          </View>
